...
int main() {
    ...
    // Realisation impossible du reste du code en raison d'un bug m'empechant d'ouvrir les nouveaux fichiers dans le projet visual studio
    // et des contraintes du TP5 qui sont inaccessibles... Les classes et fonctionnalites sont presentes, mais
    // impossible de debug, corriger le code correctement ou connaitre les textes necessaires

    std::cout << "Total du nombre d'offres de réservations dans la BDOR: " << db.getNombreOffres() << std::endl;
    return 0;
}
